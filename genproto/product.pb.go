...
func (x *ProductDTO) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
const file_product_proto_rawDesc = "" +
	...
	"\x05stock\x18\x05 \x01(\x05R\x05stock\"J\n" +
	"\x14ListProductsResponse\x122\n" +
	"\bproducts\x18\x01 \x03(\v2\x16.product.v1.ProductDTOR\bproducts2e\n" +
	"\x0eProductService\x12S\n" +
	"\fListProducts\x12\x1f.product.v1.ListProductsRequest\x1a .product.v1.ListProductsResponse\"\x00B\x1fZ\x1dgenproto/product/v1;productv1b\x06proto3"
...
var file_product_proto_goTypes = []any{
	...
	(*ProductDTO)(nil),           // 1: product.v1.ProductDTO
	(*ListProductsResponse)(nil), // 2: product.v1.ListProductsResponse
}
var file_product_proto_depIdxs = []int32{
	1, // 0: product.v1.ListProductsResponse.products:type_name -> product.v1.ProductDTO
	0, // 1: product.v1.ProductService.ListProducts:input_type -> product.v1.ListProductsRequest
	2, // 2: product.v1.ProductService.ListProducts:output_type -> product.v1.ListProductsResponse
